...
Public Class Eliminar_reservacion
    ...
    Private Sub Eliminar_reservacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Conectar()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        sql = "DELETE FROM REGISTROS WHERE COD_USU ='" & TextBox1.Text & "'"
