...
Public Class EditarEmpleados
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click

        Dim sql1 As String

        sql1 = "UPDATE EMPLEADOS  SET VALUES NOMBRE ='" & TextBox2.Text & "',APELLIDO ='" & TextBox3.Text & "',"
    ...
    Private Sub EditarEmpleados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Conectar()
