...
Public Class Reservas_del_hotel

    Private Sub Reservas_del_hotel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Else
            ...
            Me.DataGridView1.DataSource = ConsultaBuscar("registros", "cod_usu", TextBox3.Text).Tables("Tabla")
            Try
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Eliminar_reservacion.Show()
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Editar_reservacion.Show()
    End Sub
End Class